...
public class Data implements org.apache.thrift.TBase<Data, Data._Fields>, java.io.Serializable, Cloneable, Comparable<Data> {
  ...
  private static final org.apache.thrift.protocol.TField PRODUCTION_LINE_FIELD_DESC = new org.apache.thrift.protocol.TField("productionLine", org.apache.thrift.protocol.TType.LIST, (short)8);
  ...
  public List<RequestData> productionLine; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    PRODUCTION_LINE((short)8, "productionLine");
  ...
  static {
    ...
    tmpMap.put(_Fields.PRODUCTION_LINE, new org.apache.thrift.meta_data.FieldMetaData("productionLine", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, RequestData.class))));
  ...
  public Data(
    ...
    List<RequestData> productionLine)
  {
    this();
  ...
  public Data(Data other) {
    ...
    if (other.isSetProductionLine()) {
      List<RequestData> __this__productionLine = new ArrayList<RequestData>(other.productionLine.size());
      for (RequestData other_element : other.productionLine) {
        __this__productionLine.add(new RequestData(other_element));
      }
      this.productionLine = __this__productionLine;
    }
  }
  ...
  public int getProductionLineSize() {
    return (this.productionLine == null) ? 0 : this.productionLine.size();
  }

  public java.util.Iterator<RequestData> getProductionLineIterator() {
    return (this.productionLine == null) ? null : this.productionLine.iterator();
  }

  public void addToProductionLine(RequestData elem) {
    if (this.productionLine == null) {
      this.productionLine = new ArrayList<RequestData>();
    }
    this.productionLine.add(elem);
  }

  public List<RequestData> getProductionLine() {
    return this.productionLine;
  }

  public Data setProductionLine(List<RequestData> productionLine) {
    this.productionLine = productionLine;
    return this;
  }

  public void unsetProductionLine() {
    this.productionLine = null;
  }

  /** Returns true if field productionLine is set (has been assigned a value) and false otherwise */
  public boolean isSetProductionLine() {
    return this.productionLine != null;
  }

  public void setProductionLineIsSet(boolean value) {
    if (!value) {
      this.productionLine = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case PRODUCTION_LINE:
      if (value == null) {
        ...
        setProductionLine((List<RequestData>)value);
      }
      break;
  ...
  public boolean equals(Data that) {
    ...
    boolean this_present_productionLine = true && this.isSetProductionLine();
    boolean that_present_productionLine = true && that.isSetProductionLine();
    if (this_present_productionLine || that_present_productionLine) {
      if (!(this_present_productionLine && that_present_productionLine))
        return false;
      if (!this.productionLine.equals(that.productionLine))
        return false;
    }
  ...
  public int compareTo(Data other) {
    ...
    lastComparison = Boolean.valueOf(isSetProductionLine()).compareTo(other.isSetProductionLine());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetProductionLine()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.productionLine, other.productionLine);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    first = false;
    if (!first) sb.append(", ");
    sb.append("productionLine:");
    if (this.productionLine == null) {
      sb.append("null");
    } else {
      sb.append(this.productionLine);
    }
    first = false;
    sb.append(")");
    return sb.toString();
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.owned_planes = new ArrayList<PlaneFullData>(_list24.size);
                for (int _i25 = 0; _i25 < _list24.size; ++_i25)
                {
                  PlaneFullData _elem26;
                  _elem26 = new PlaneFullData();
                  _elem26.read(iprot);
                  struct.owned_planes.add(_elem26);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.not_owned_planes = new ArrayList<PlaneBasicData>(_list27.size);
                for (int _i28 = 0; _i28 < _list27.size; ++_i28)
                {
                  PlaneBasicData _elem29;
                  _elem29 = new PlaneBasicData();
                  _elem29.read(iprot);
                  struct.not_owned_planes.add(_elem29);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.owned_bases = new ArrayList<BaseFullData>(_list30.size);
                for (int _i31 = 0; _i31 < _list30.size; ++_i31)
                {
                  BaseFullData _elem32;
                  _elem32 = new BaseFullData();
                  _elem32.read(iprot);
                  struct.owned_bases.add(_elem32);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.not_owned_visible_bases = new ArrayList<BaseFullData>(_list33.size);
                for (int _i34 = 0; _i34 < _list33.size; ++_i34)
                {
                  BaseFullData _elem35;
                  _elem35 = new BaseFullData();
                  _elem35.read(iprot);
                  struct.not_owned_visible_bases.add(_elem35);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.not_owned_not_visible_bases = new ArrayList<BaseBasicData>(_list36.size);
                for (int _i37 = 0; _i37 < _list36.size; ++_i37)
                {
                  BaseBasicData _elem38;
                  _elem38 = new BaseBasicData();
                  _elem38.read(iprot);
                  struct.not_owned_not_visible_bases.add(_elem38);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.progressAxis = new ArrayList<ProgressAxisData>(_list39.size);
                for (int _i40 = 0; _i40 < _list39.size; ++_i40)
                {
                  ProgressAxisData _elem41;
                  _elem41 = new ProgressAxisData();
                  _elem41.read(iprot);
                  struct.progressAxis.add(_elem41);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.productionLine = new ArrayList<RequestData>(_list42.size);
                for (int _i43 = 0; _i43 < _list42.size; ++_i43)
                {
                  RequestData _elem44;
                  _elem44 = new RequestData();
                  _elem44.read(iprot);
                  struct.productionLine.add(_elem44);
                }
                iprot.readListEnd();
              }
              struct.setProductionLineIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Data struct) throws org.apache.thrift.TException {
      ...
      if (struct.owned_planes != null) {
        oprot.writeFieldBegin(OWNED_PLANES_FIELD_DESC);
        {
          ...
          for (PlaneFullData _iter45 : struct.owned_planes)
          {
            _iter45.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.not_owned_planes != null) {
        oprot.writeFieldBegin(NOT_OWNED_PLANES_FIELD_DESC);
        {
          ...
          for (PlaneBasicData _iter46 : struct.not_owned_planes)
          {
            _iter46.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.owned_bases != null) {
        oprot.writeFieldBegin(OWNED_BASES_FIELD_DESC);
        {
          ...
          for (BaseFullData _iter47 : struct.owned_bases)
          {
            _iter47.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.not_owned_visible_bases != null) {
        oprot.writeFieldBegin(NOT_OWNED_VISIBLE_BASES_FIELD_DESC);
        {
          ...
          for (BaseFullData _iter48 : struct.not_owned_visible_bases)
          {
            _iter48.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.not_owned_not_visible_bases != null) {
        oprot.writeFieldBegin(NOT_OWNED_NOT_VISIBLE_BASES_FIELD_DESC);
        {
          ...
          for (BaseBasicData _iter49 : struct.not_owned_not_visible_bases)
          {
            _iter49.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.progressAxis != null) {
        oprot.writeFieldBegin(PROGRESS_AXIS_FIELD_DESC);
        {
          ...
          for (ProgressAxisData _iter50 : struct.progressAxis)
          {
            _iter50.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.productionLine != null) {
        oprot.writeFieldBegin(PRODUCTION_LINE_FIELD_DESC);
        {
          oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.productionLine.size()));
          for (RequestData _iter51 : struct.productionLine)
          {
            _iter51.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class DataTupleScheme extends TupleScheme<Data> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, Data struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetNot_owned_visible_bases()) {
        {
          ...
          for (BaseFullData _iter55 : struct.not_owned_visible_bases)
          {
            _iter55.write(oprot);
          }
        }
      ...
      if (struct.isSetNot_owned_not_visible_bases()) {
        {
          ...
          for (BaseBasicData _iter56 : struct.not_owned_not_visible_bases)
          {
            _iter56.write(oprot);
          }
        }
      ...
      if (struct.isSetProgressAxis()) {
        {
          ...
          for (ProgressAxisData _iter57 : struct.progressAxis)
          {
            _iter57.write(oprot);
          }
        }
      ...
      if (struct.isSetProductionLine()) {
        {
          oprot.writeI32(struct.productionLine.size());
          for (RequestData _iter58 : struct.productionLine)
          {
            _iter58.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.owned_planes = new ArrayList<PlaneFullData>(_list59.size);
          for (int _i60 = 0; _i60 < _list59.size; ++_i60)
          {
            PlaneFullData _elem61;
            _elem61 = new PlaneFullData();
            _elem61.read(iprot);
            struct.owned_planes.add(_elem61);
          }
        }
        struct.setOwned_planesIsSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          struct.not_owned_planes = new ArrayList<PlaneBasicData>(_list62.size);
          for (int _i63 = 0; _i63 < _list62.size; ++_i63)
          {
            PlaneBasicData _elem64;
            _elem64 = new PlaneBasicData();
            _elem64.read(iprot);
            struct.not_owned_planes.add(_elem64);
          }
        }
        struct.setNot_owned_planesIsSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          struct.owned_bases = new ArrayList<BaseFullData>(_list65.size);
          for (int _i66 = 0; _i66 < _list65.size; ++_i66)
          {
            BaseFullData _elem67;
            _elem67 = new BaseFullData();
            _elem67.read(iprot);
            struct.owned_bases.add(_elem67);
          }
        }
        struct.setOwned_basesIsSet(true);
      }
      if (incoming.get(4)) {
        {
          ...
          struct.not_owned_visible_bases = new ArrayList<BaseFullData>(_list68.size);
          for (int _i69 = 0; _i69 < _list68.size; ++_i69)
          {
            BaseFullData _elem70;
            _elem70 = new BaseFullData();
            _elem70.read(iprot);
            struct.not_owned_visible_bases.add(_elem70);
          }
        }
        struct.setNot_owned_visible_basesIsSet(true);
      }
      if (incoming.get(5)) {
        {
          ...
          struct.not_owned_not_visible_bases = new ArrayList<BaseBasicData>(_list71.size);
          for (int _i72 = 0; _i72 < _list71.size; ++_i72)
          {
            BaseBasicData _elem73;
            _elem73 = new BaseBasicData();
            _elem73.read(iprot);
            struct.not_owned_not_visible_bases.add(_elem73);
          }
        }
        struct.setNot_owned_not_visible_basesIsSet(true);
      }
      if (incoming.get(6)) {
        {
          ...
          struct.progressAxis = new ArrayList<ProgressAxisData>(_list74.size);
          for (int _i75 = 0; _i75 < _list74.size; ++_i75)
          {
            ProgressAxisData _elem76;
            _elem76 = new ProgressAxisData();
            _elem76.read(iprot);
            struct.progressAxis.add(_elem76);
          }
        }
        struct.setProgressAxisIsSet(true);
      }
      if (incoming.get(7)) {
        {
          ...
          struct.productionLine = new ArrayList<RequestData>(_list77.size);
          for (int _i78 = 0; _i78 < _list77.size; ++_i78)
          {
            RequestData _elem79;
            _elem79 = new RequestData();
            _elem79.read(iprot);
            struct.productionLine.add(_elem79);
          }
        }
        struct.setProductionLineIsSet(true);
      }
